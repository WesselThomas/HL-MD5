...
# IV1 = [4009666844,4185421068,320656731,1175793337]
# block = [1995308996,178036439,3627068063,802637657,2276536994,2009833304,2122522194,3926665805,4022193338,2019444322,3679381515,271403482,3990310567,2053095155,2001728714,4076199768]
#
# res = md5_compress(IV1, block)
# print(res)
# goal = [3429429298,2851287823,4033797907,3221367228]
# print(goal)
